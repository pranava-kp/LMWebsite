          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {allProfiles.map((profile) => (
              <div
                ...
                className="bg-gray-50 border border-gray-200 rounded-lg shadow-md p-4 flex flex-col justify-between relative hover:shadow-lg transition-all duration-300 group"
              >
